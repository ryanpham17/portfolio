    ...
    <div className={styles.sectionContainer}>
        <div className={styles.aboutContainer}>
            ...
            <div className={styles.aboutDetailsContainer}>
                ...
                <div>
                    <p className={styles.textContainer}>Hi, I'm Ryan Pham, a Computer Science student at California State Polytechnic University, Pomona. My interests include artificial intelligence, machine learning, computer vision, and full-stack development. I enjoy building software and applying what I learn to real-world projects. After earning my bachelor's degree, I plan to pursue a master's in Computer Science with a focus on machine learning. I'm currently seeking software engineering opportunities where I can continue learning, solve meaningful problems, and contribute to impactful projects.</p>
                </div>
            </div>
        </div>
